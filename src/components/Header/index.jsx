...
function Header(props) {
  ...
  return (
    <header className="header">
        ...
        <div className="row">
          <nav className="navbar navbar-expand-lg navbar-dark">
            <div className="container-fluid flex-row-reverse">
              ...
              <img className="d-lg-none" src="https://vendor.webuildthemes.com/assets/images/logo.svg" alt="..." />
              <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <div className="col col-4 text-center d-none d-lg-block">
                  <NavLink to='/home'>
                    <img src="https://vendor.webuildthemes.com/assets/images/logo.svg" alt="" />
                  </NavLink>
                </div>
                <div className="col col-4">
                  <ul className="navbar-nav me-auto mb-2 mb-xl-0 justify-content-end">
                    <li className="nav-item">
                      <NavLink to='/login' className="nav-link" role="button"
                        aria-expanded="false">Login</NavLink>
                    </li>
      ...
      <div className={searchUI ? 'header__search active' : 'header__search'}>
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="search__group">
            <input type="text" className="text-dark" placeholder="Type your search here" />
